...
public class RegisteredEventAdapter1 extends RecyclerView.Adapter<RegisteredEventAdapter1.viewHolder> {
    ArrayList<EventClass> eventList;
    Context context;

    //initializing the eventAdapter constructor
    public RegisteredEventAdapter1(ArrayList<EventClass> eventList, Context context) {
        this.eventList = eventList;
        this.context = context;
    }
    @NonNull
    @Override
    public RegisteredEventAdapter1.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.fragment_registeredevents_recyclerview, parent, false);
        return new viewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RegisteredEventAdapter1.viewHolder holder, int position) {
