 ...
 */
public class RegisteredEventsFragment1 extends Fragment {
    View root;
    ViewPager viewPager;
    TabLayout tabLayout;
    public RegisteredEventsFragment1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.fragment_registered_events1, container, false);
